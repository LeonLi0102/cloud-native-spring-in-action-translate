...
您终于可以从 localhost 的 9001 端口调用应用程序了，所有请求将被转发到 Service 对象，最终转发到 Catalog Service Pod。尝试从浏览器访问 http://localhost:9001 查看欢迎消息，或访问 http://localhost:9001/books 浏览目录中可用的图书。
