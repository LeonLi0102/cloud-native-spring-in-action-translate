...
Deployment 是管理无状态、副本化应用程序生命周期的对象。每个副本由一个 Pod 表示。副本分布在集群的各个节点上，以实现更好的韧性（[https://kubernetes.io/docs/reference/glossary](https://kubernetes.io/docs/reference/glossary)）。
