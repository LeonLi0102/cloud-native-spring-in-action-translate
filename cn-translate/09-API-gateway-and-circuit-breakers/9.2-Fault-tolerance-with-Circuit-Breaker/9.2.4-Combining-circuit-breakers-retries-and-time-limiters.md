...
你可以使用 Apache Benchmark（[https://httpd.apache.org/docs/2.4/programs/ab.html](https://httpd.apache.org/docs/2.4/programs/ab.html)）等工具来验证将这些模式应用于 Edge Service 的结果。如果你使用 macOS 或 Linux，可能已经安装了此工具。否则，你可以按照官方网站的说明进行安装。
