...
> **注意：** 如果你想了解更多关于令牌桶算法的信息，我建议阅读 Paul Tarjan 的"Scaling your API with Rate Limiters"文章，了解他们如何在 Stripe 使用它来实现限流器（[https://stripe.com/blog/rate-limiters](https://stripe.com/blog/rate-limiters)）。
