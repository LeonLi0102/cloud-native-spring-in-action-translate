...
在 Java 生态系统中，最常用的跟踪、版本控制和部署数据库更改的两个工具是 Flyway（[https://flywaydb.org](https://flywaydb.org)）和 Liquibase（[https://liquibase.org](https://liquibase.org)）。它们都与 Spring Boot 完全集成。本节将展示如何使用 Flyway。
...
> 注意：本节将介绍 Flyway 提供的一些功能，但建议您查阅官方文档以发现此工具提供的所有强大功能（[https://flywaydb.org](https://flywaydb.org)）。
