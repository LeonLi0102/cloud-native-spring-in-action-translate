...
您可以从 Spring Initializr（[https://start.spring.io](https://start.spring.io)）初始化 Dispatcher Service 项目，并将结果存储在新的 dispatcher-service Git 仓库中。初始化参数如图 10.7 所示。
