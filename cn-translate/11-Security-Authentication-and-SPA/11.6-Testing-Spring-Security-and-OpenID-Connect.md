...
最后，在更新 Edge Service 的部署脚本以配置 Polar UI 和 Keycloak 的 URL 后，尝试在 Kubernetes 上运行整个系统。您可以参考本书附带源代码仓库中的 Chapter11/11-end 文件夹以查看最终结果（[https://github.com/ThomasVitale/cloud-native-spring-in-action](https://github.com/ThomasVitale/cloud-native-spring-in-action)）。
