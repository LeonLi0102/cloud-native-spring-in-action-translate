...
> **注意** 每当我提到 OIDC 时，我指的是 OpenID Connect Core 1.0 规范（[https://openid.net/specs/openid-connect-core-1_0.html](https://openid.net/specs/openid-connect-core-1_0.html)）。每当我提到 OAuth2 时，除非另有说明，我指的是目前正在标准化的 OAuth 2.1 规范（[https://oauth.net/2/1](https://oauth.net/2/1)），旨在取代 RFC 6749（[https://tools.ietf.org/html/rfc6749](https://tools.ietf.org/html/rfc6749)）中描述的 OAuth 2.0 标准。
...
> **注意** 出于调试目的，您可以使用 [https://jwt.io](https://jwt.io) 上的工具来编码和解码令牌。
...
> **注意** 如果您有兴趣了解更多关于 JWT 及其相关方面的信息，可以参考 IETF 标准规范。JSON Web Token（JWT）记录在 RFC 7519（[https://tools.ietf.org/html/rfc7519](https://tools.ietf.org/html/rfc7519)）中，JSON Web Signature（JWS）在 RFC 7515（[https://tools.ietf.org/html/rfc7515](https://tools.ietf.org/html/rfc7515)）中描述，JSON Web Encryption（JWE）在 RFC 7516（[https://tools.ietf.org/html/rfc7516](https://tools.ietf.org/html/rfc7516)）中介绍。您可能还对 JSON Web Algorithms（JWA）感兴趣，它定义了 JWT 的可用加密操作，并在 RFC 7518（[https://tools.ietf.org/html/rfc7518](https://tools.ietf.org/html/rfc7518)）中详细说明。
